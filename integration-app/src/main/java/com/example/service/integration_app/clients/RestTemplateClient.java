...
//
//        MultiValuedMap<String, Object> body = new LinkedMultiValueMap<>();
//        body.add("file", file);
//
//        HttpEntity<MultiValueMap<String, Object>> requestEntity = new HttpEntity<>(body, headers);
//
//        restTemplate.postForEntity(baseUrl + "/api/v1/file/upload", requestEntity, String.class);
//    }
//
...
//        restTemplate.exchange(baseUrl + "/api/v1/entity/{id}",
//                HttpMethod.DELETE,
//                null,
//                Void.class,
//                id
